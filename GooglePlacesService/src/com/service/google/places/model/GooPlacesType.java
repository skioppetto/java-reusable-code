...
public enum GooPlacesType {
	/*list of all known google place types*/
	...
	electronics_store, embassy, establishment, finance, fire_station, florist, 
	food, funeral_home, furniture_store, gas_station, general_contractor, 
	geocode, grocery_or_supermarket, gym, hair_care, hardware_store, 
	...
	taxi_stand, train_station, travel_agency, university, veterinary_care, 
	zoo, administrative_area_level_1, administrative_area_level_2, 
	administrative_area_level_3, colloquial_area, country, floor, 
	intersection, locality, natural_feature, neighborhood, political, 
	point_of_interest, post_box, postal_code, postal_code_prefix, postal_town,
